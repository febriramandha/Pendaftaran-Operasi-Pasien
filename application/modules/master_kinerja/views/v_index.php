                            ...
                            foreach ($row as $key => $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('master_kinerja/edit/' . $data->id); ?>" class="btn btn-warning btn-xs">
                                            <i class="fas fa-pen"></i> Edit
                                        </a>
                                        <a href="<?= site_url('master_kinerja/delete/' . $data->id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin ingin hapus?')">
            ...
            <div class="modal-body">
                <form action="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="modul_kinerja" placeholder="Input Modul Kinerja">
                    </div>
                </form>
            </div>
