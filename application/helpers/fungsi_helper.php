...
function status_ok($status)
{
    ...
    if ($status == '1') {
        $a = '<span class="badge badge-pill badge-danger font-size-14">Pasien Batal</span>';
    } else {
        $a = '<span class="badge badge-pill badge-success font-size-14">Penjadwalan Prioritas Tindakan</span>';
    }
