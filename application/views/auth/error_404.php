    ...
    <section class="content">
        <div class="error-page">
            ...
            <div class="error-content">
                <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Sepertinya Anda Tersesat.</h3>
                <p>
                    Halaman yang anda cari tidak ditemukan di dalam sistem kami.
                </p>
                <a href="<?= base_url(); ?>" class="btn btn-warning btn-block"><i class="fas fa-sign-out-alt"></i> Kembali</a>
            </div>
